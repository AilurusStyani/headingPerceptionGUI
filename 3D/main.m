...
% Last Modified by GUIDE v2.5 29-Jul-2019 14:30:39
...
% TRIALINFO.headingPC = [-90 90]; % positive control
% TRIALINFO.repeatPC = 7; % repeat number for each positive control
